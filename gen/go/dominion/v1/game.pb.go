...
func (x *Decision) GetTrashFromRevealed() *TrashFromRevealedPrompt {
	if x != nil {
		if x, ok := x.Prompt.(*Decision_TrashFromRevealed); ok {
			return x.TrashFromRevealed
		}
	}
	return nil
}
...
type TrashFromRevealedPrompt struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cards         []string               `protobuf:"bytes,1,rep,name=cards,proto3" json:"cards,omitempty"` // the revealed cards the player may choose from
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TrashFromRevealedPrompt) Reset() {
	*x = TrashFromRevealedPrompt{}
	mi := &file_dominion_v1_game_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TrashFromRevealedPrompt) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrashFromRevealedPrompt) ProtoMessage() {}

func (x *TrashFromRevealedPrompt) ProtoReflect() protoreflect.Message {
	mi := &file_dominion_v1_game_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrashFromRevealedPrompt.ProtoReflect.Descriptor instead.
func (*TrashFromRevealedPrompt) Descriptor() ([]byte, []int) {
	return file_dominion_v1_game_proto_rawDescGZIP(), []int{13}
}

func (x *TrashFromRevealedPrompt) GetCards() []string {
	if x != nil {
		return x.Cards
	}
	return nil
